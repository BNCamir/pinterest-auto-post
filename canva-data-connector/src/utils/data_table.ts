...
/**
 * Creates a media cell for the data table (images/videos).
 */
export function mediaCell(
  value: DataTableImageUpload[] | unknown,
): { type: "media"; value: DataTableImageUpload[] } {
  return { type: "media", value: Array.isArray(value) ? value : [] };
}
